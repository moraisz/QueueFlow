...
use Src\Infrastructure\Repositories\MockCustomerRepository as CustomerRepository;

class CustomerController {
    public function get(Request $request, Response $response): Response {
        $customerUseCase = new GetCustomersUseCase(new CustomerRepository());
    ...
    public function getUnique(Request $request, Response $response): Response {
        $customerUseCase = new GetCustomerByIdUseCase(new CustomerRepository());
    ...
    public function post(Request $request, Response $response): Response {
        $customerUseCase = new CreateCustomerUseCase(new CustomerRepository());
